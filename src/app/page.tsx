...
export default function About() {
  const structure = [
    ...
    {
      title: about.educations.title,
      display: about.educations.display,
      items: about.educations.institutions.map(
    ...
    <Column maxWidth="m">
      ...
      <Flex fillWidth mobileDirection="column" horizontal="center">
        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          {about.educations.display && (
            <>
              <Heading
                as="h2"
                id={about.educations.title}
                variant="display-strong-s"
                marginBottom="m"
              >
                {about.educations.title}
              </Heading>
              <Column fillWidth gap="l" marginBottom="40">
                {about.educations.institutions.map((institution, index) => (
                  <Column
